...
 2.	Każdy kandydat otrzymuje:
	1) jeden egzemplarz zestawu pytań testowych, zawarty na 38 stronach; 
	2) jeden egzemplarz karty odpowiedzi, zawarty na 4 stronach.

 3.	Przed przystąpieniem do rozwiązania zestawu pytań testowych należy sprawdzić, czy zawiera on wszystkie kolejno ponumerowane strony od 1 do 38 oraz czy karta odpowiedzi zawiera 4 strony. W przypadku braku którejkolwiek ze stron, należy 
...
questions_raw = questions_raw.replace("B	w całości, z własnych środków, płatnicy składek,", "B.	w całości, z własnych środków, płatnicy składek,")
